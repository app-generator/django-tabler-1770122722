...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-tabler-1770122722) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-tabler-1770122722.git
$ cd django-tabler-1770122722
```
